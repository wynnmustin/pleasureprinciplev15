...
for(var i = 0; i < category.length; i++){
   ...
   // }
     if (selectedCategory == 'tobacco') {
        ...
        document.getElementById("logopages2").innerHTML = "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>" ;
        document.getElementById("logopages3").innerHTML = "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>" ;
         document.getElementById("logopages4").innerHTML = "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>" + "<img src='img/tobaccolrg.png'>";
        ...
        document.getElementById("logopages2").innerHTML = "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>" ;
        document.getElementById("logopages3").innerHTML = "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>" ;
         document.getElementById("logopages4").innerHTML = "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>" + "<img src='img/alcohol.png'>";
        ...
        document.getElementById("logopages2").innerHTML = "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>" ;
        document.getElementById("logopages3").innerHTML = "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>" ;
         document.getElementById("logopages4").innerHTML = "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>" + "<img src='img/snacks.png'>";
        ...
        document.getElementById("logopages2").innerHTML = "<img src='img/other.png'>" + "<img src='img/other.png'>" ;
        document.getElementById("logopages3").innerHTML = "<img src='img/other.png'>" + "<img src='img/other.png'>" + "<img src='img/other.png'>" ;
         document.getElementById("logopages4").innerHTML = "<img src='img/other.png'>" + "<img src='img/other.png'>" + "<img src='img/other.png'>" + "<img src='img/other.png'>";
